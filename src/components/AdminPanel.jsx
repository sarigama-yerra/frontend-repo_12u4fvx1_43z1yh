        ...
        <div className="p-4">
          {!authed ? (
            <div className="space-y-3">
              <p className="text-white/70 text-sm">Enter your passcode to unlock editing. This only stays in your browser during this session.</p>
              <div className="flex gap-2">
                ...
                <button onClick={() => setAuthed(!!passcode)} className="rounded-lg bg-white text-black px-4 py-2">Unlock</button>
              </div>
